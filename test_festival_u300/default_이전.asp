                    ...
                    <div class="inner">
                        ...
                        <div id="multilines">
                            <div class="guest_book1">
                                ...
                                <%
                                sql_p = "select   top(20) c_content, c_member_id, c_date, c_no from tbl_puzzle where c_year = 2021 and c_use = 0 and c_order > 2 order by c_no desc "
				Set rs=CreateObject("ADODB.RecordSet")
				rs.Open sql_p, dbCon, 1
				If rs.EOF Then 
				else
                    ...
                    <div class="mid_con">
                        ...
                        <div class="fes_info tac">
                            ...
                            <div class="">
                                ...
                                <div class="mgt35 tac co0d fs30">2021.08.04 ~ 2021.08.15</div>
...
<form name="kdb">                
                 <section class="startup_list" id="go_tab">
                    ...
                    <div class="tab-select-outer">
                        <select class="tab_select" name="c_festival_type" onchange="location.href='default.asp?c_festival_type=' + this.value">
