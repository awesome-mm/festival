...
-->
                    <div class="tab_menu2">
                        <ul>
                            ...
                            <li data-id="con4" <%if now_p = 5 then%>class="on"<%end if%>>
                                <a href="list.asp?<%=t_para%>&now_p=5">퍼즐 No5</a>
                            </li>
                            <li data-id="con4" <%if now_p = 6 then%>class="on"<%end if%>>
		...
		<% end if%>
          ...
          <section>
			...
			<div class="comment_write">
                            <!--
                            <textarea  name="c_content" placeholder="<%=place_t%>" o1nfocus="<%if kkp = 1 then%>go_login()<%end if%><%if kkp = 3 then%>gogo()<%end if%>" style="text-align:left"></textarea>
