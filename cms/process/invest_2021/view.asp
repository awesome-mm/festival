...
<form name="kdb">
	  <div class="wrapper">
	  	 <section style="">
                    <div class="title3" style="border-bottom:#cdcdcd solid 1px; margin: 16rem auto 0rem;padding-bottom:40px">
                        <div>
				...
				Set rs_d=Nothing
                            ...
                            <div class="con2_reply">
                                <table>
                                    <tbody>
				 <%
                        	sql_d = "select   a.c_date,a.c_exp, b.c_id from tbl_fund a inner join tbl_member b on b.c_no = a.c_member_no and c_use = 0 where a.c_year = 2021 and a.c_team_no = "& c_team_no &" and a.c_use = 0 and a.c_member_type = 1 order by newid()"
                        	Set rs_d=CreateObject("ADODB.RecordSet")
				rs_d.Open sql_d, dbCon, 1
				If rs_d.EOF Then  
				else
                            ...
                            <div class="con2_reply">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <%
	                        	sql_d = "select   a.c_date,a.c_exp, b.c_id from tbl_fund a inner join tbl_member b on b.c_no = a.c_member_no and c_use = 0 where a.c_year = 2021 and a.c_team_no = "& c_team_no &" and a.c_use = 0 and a.c_member_type = 2 order by newid()"
	                        	Set rs_d=CreateObject("ADODB.RecordSet")
					rs_d.Open sql_d, dbCon, 1
					If rs_d.EOF Then  
					else
				...
				Set rs_d=Nothing
                            ...
                            <div class="con2_reply">
                                ...
                                <table>
                                    <tbody>
					<%
	                        	sql_d = "select   a.c_date,a.c_exp, b.c_name from tbl_fund a inner join tbl_temp_tester b on b.c_no = a.c_member_no  where a.c_year = 2021 and a.c_team_no = "& c_team_no &" and a.c_use = 0 and a.c_member_type = 3 order by newid()"
	                        	Set rs_d=CreateObject("ADODB.RecordSet")
					rs_d.Open sql_d, dbCon, 1
					If rs_d.EOF Then  
					else
