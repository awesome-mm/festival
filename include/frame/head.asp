...
<% If InStr(sUsrAgent, "ANDROID") > 0 or InStr(sUsrAgent, "IPAD") Or InStr(sUsrAgent, "IPHONE") Then %>
	...
	<script language='javascript'>
		var _AceGID=(function(){var Inf=['festival.u300.or.kr','festival.u300.or.kr','AX2A93847','AM','0','NaPm,Ncisy','ALL','0']; var _CI=(!_AceGID)?[]:_AceGID.val;var _N=0;if(_CI.join('.').indexOf(Inf[3])<0){ _CI.push(Inf);  _N=_CI.length; } return {o: _N,val:_CI}; })();
