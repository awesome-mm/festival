...
<!--
벌레찾기
head.asp에서 db열고 로그인계정 id를 기준으로 이스터에그관련 정보들 세션에 담아두고
해당 세션의 값들이 0일 경우에만 벌레관련태그,js들이 실행되도록 asp if문을 통해 제어
벌레1 : cms/process/invest/list.asp 프로젝트더보기버튼3번 누르면출현
벌레2 : cms/process/invest/view.asp 랜덤난수1~10 발생 1,2,3 뜰 경우 벌레 출현
벌레3 : 
벌레4 : 
벌레5 : 
-->